...
class StartScene : SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        let bckgndImage = SKTexture(imageNamed: "BackgroundImage.png")
        background = SKSpriteNode(texture: bckgndImage)
        ...
        print(titleTexture.size())
//        title.size                  = CGSize(width: sceneWidth/2.0, height: 100)
